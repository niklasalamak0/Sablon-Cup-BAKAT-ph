...
export default function VideoSection() {
  return (
    <section
      id="video"
      className="py-16 md:py-24 bg-gradient-to-br from-orange-50 to-white border-t border-orange-100 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-10">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <p className="text-orange-600 text-xs md:text-sm font-bold tracking-[0.2em] uppercase">
                  Proses Produksi
                </p>
              </div>

              <h2 className="text-4xl md:text-5xl font-black text-gray-950 leading-[1.2]">
            ...
            <div className="grid gap-4">
              {[
                ...
                },
                {
                  ...
                  desc: "Setiap cup dicek secara visual dan fungsi sebelum dikirim, untuk memastikan hasil sablon rapi dan sesuai standar.",
                  icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />,
                },
                {
                  title: "Pengerjaan Cepat",
                  desc: "Alur kerja produksi disusun efisien dan terstruktur, sehingga pesanan selesai tepat waktu tanpa mengurangi kualitas.",
          ...
          <div className="relative group">
            ...
            <div className="absolute -inset-4 bg-gradient-to-tr from-orange-500/20 to-amber-400/10 blur-3xl rounded-[2.5rem] -z-10 opacity-50 group-hover:opacity-100 transition-opacity"></div>
            
            {/* Video Container */}
            <div className="relative aspect-[9/16] md:aspect-video lg:aspect-[4/5] w-full max-w-[420px] mx-auto rounded-[2.5rem] overflow-hidden shadow-2xl border-[8px] border-white bg-gray-900 group-hover:scale-[1.01] transition-transform duration-500">
            ...
            {/* Animated Bottom Floating Badge */}
            <div className="absolute -bottom-4 -right-2 md:right-4 bg-white p-4 rounded-2xl shadow-2xl border border-gray-100 z-30 hidden sm:flex items-center gap-4 animate-bounce">
               <div className="bg-emerald-100 p-2.5 rounded-xl text-emerald-600 font-black text-sm shadow-inner">100%</div>
               <div className="text-[10px] font-bold text-gray-800 leading-tight uppercase tracking-tight">
