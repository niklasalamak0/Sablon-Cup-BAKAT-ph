...
{/* GRID UTAMA - Diperbarui untuk kesan Premium & Sinematik */}
<div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
  ...
  <div className="space-y-8">
    <div>
      ...
      <p className="text-gray-600 text-lg leading-relaxed max-w-xl italic">
        "Kami tidak hanya mencetak logo, kami memastikan setiap detail pada cup Anda mewakili standar brand yang tinggi."
      </p>
    </div>
    ...
    {/* FEATURE LIST - Menggunakan Teks Asli dengan Style Baru */}
  ...
  <div className="relative group">
    ...
    <div className="relative aspect-[9/16] md:aspect-video lg:aspect-[4/5] w-full max-w-[450px] mx-auto rounded-[2rem] overflow-hidden shadow-2xl border-[6px] border-white bg-gray-900 group-hover:scale-[1.02] transition-transform duration-500">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none bg-black/10 opacity-0 group-hover:opacity-100 transition-opacity">
         <div className="w-16 h-16 bg-white/30 backdrop-blur-xl rounded-full flex items-center justify-center border border-white/50 scale-75 group-hover:scale-100 transition-transform duration-500">
